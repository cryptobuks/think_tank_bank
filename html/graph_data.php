...
$sql = 'SELECT *, COUNT(*) as count FROM people_thinktank GROUP BY person_id ORDER BY count DESC LIMIT 350';
...
foreach ($jobs as $job) { 
    ...
    foreach($results as $result) {
        ...
        if (is_numeric($thinktank_index) && is_numeric($person_index)) { 
            ...
            //echo ' --> ' . $person_index;
            //echo "\n\n";
            $output['links'][]   = (object)array('source' => $person_index, 'target' => $thinktank_index, 'value' => 4);
        }
    }
