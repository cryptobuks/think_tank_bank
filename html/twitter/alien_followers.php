...
$aliens = $db->fetch("SELECT * FROM alien_cache LIMIT 500,100");
    ...
    foreach($data->ids as $id) {
        ...
        if (count($is_person) >= 1){
            ...
            if (count($exists_results) == 0){
                echo "<p>Add</p>";
                $db->query("INSERT INTO people_followees (followee_id, follower_id, network_inclusion) VALUES ('$followee', '$follower', '4')");
            }
            else { 
                echo "<p>Already in</p>";
            }
